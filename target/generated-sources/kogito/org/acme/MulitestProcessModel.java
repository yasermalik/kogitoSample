...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "mulitestProcess", name = "MulitestProcess", hidden = false)
public class MulitestProcessModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<MulitestProcessModelOutput> {
    ...
    @Override()
    public MulitestProcessModelOutput toModel() {
        MulitestProcessModelOutput result = new MulitestProcessModelOutput();
        result.setId(getId());
